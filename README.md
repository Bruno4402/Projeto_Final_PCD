...
Repositório para armazenar projeto final da disciplina de Práticas em Ciência de Dados (PCD), do 1° semestre do curso de Ciência e Tecnologia na Ilum.

## 🚀 Sobre o projeto:

O objetivo deste projeto é automatizar operações utilizando bras e kets (notação de Dirac), fundamentais em cálculos de mecânica e computação quântica. 
...
Todas essas operações estão inclusas em um menu, possibilitando ao usuário que ele escolha uma operação, entre com valores e receba o resultado. É importante ressaltar que cada operação requer dados diferentes, que serão solicitados ao usuário após a escolha da operação.

<div align="center">
  <img src="https://github.com/Bruno4402/Projeto_Final_PCD/blob/main/Menu%20do%20programa%20de%20Bras%20e%20Kets.png" width="600" alt="Menu do programa">
</div>
...
- **Bibliotecas utilizadas:**
  - Math
  - Numpy
- **Gemini IA (Google)** para o melhor entendimento de algumas funções embutidas em Python, bem como da biblioteca Numpy. 
...
- Prof. Dr. Daniel Roberto Cassar (https://github.com/drcassar)
- Prof. Dr. James Moraes de Almeida (https://github.com/jamesmalmeida)
- Prof. Dr. Leandro Nascimento Lemos (https://github.com/llemos)
  
Por me guiarem nos meus primeiros passos da programação.
 
Ao Prof. Dr. Felipe David Crasto de Lima, por me transmitir os conceitos teóricos da notação de Dirac, que trouxeram inspiração para a realização desse programa.

## 📘 Referência bibliográfica:

LIMA, Felipe. **Álgebra Linear**. Campinas: Ilum Escola de Ciência, CNPEM, 4 mar. 2026. Notas de aula.
